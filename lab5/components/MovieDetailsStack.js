...
import { MovieImageChanger } from "../global/MovieImageChanger";
import { MovieDetailsChanger } from "../global/MovieDetailsChanger";
...
export default function MovieDetailsStack({ route }) {
    ...
    const data = MovieDetailsChanger(id)
                    ...
                    <View style={orientation().infoScreen}>
                        <View style={orientation().infoImageSection}>
                            <Image
                                ...
                                source={MovieImageChanger(data.Poster)}
                            />
                        </View>
